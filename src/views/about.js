    ...
    <section class="view view--about">
      ...
      <div class="aboutContent">
        <section class="aboutSection">
          <h2 class="aboutSection__title">¿Qué demonios es este sitio?</h2>
          <p>Es un chat inmersivo donde puedes hablar conmigo. Sí, exacto, con Shrek. ¿No tenías nada mejor que hacer?</p>
        </section>

        <section class="aboutSection">
          <h2 class="aboutSection__title">¿Magia? ¡No, Inteligencia Artificial!</h2>
        ...
        <section class="aboutSection">
          <h2 class="aboutSection__title">¿Quién es el culpable de esto?</h2>
          <p>Todo este código de JavaScript y CSS lo armó Juan Patricio Maydana para su proyecto SPA. Así que si algo falla, ¡échale la culpa a él, no a mí!</p>
        </section>
      </div>
    </section>
  `;
